...
{
    class Rect : ToolButton, IButtonable, IDrawUsable
    {
        ...
        public System.Windows.Forms.Button GetButton()
        {
            ...
            button.BackgroundImage = ((System.Drawing.Image)
                (global::FPaint.Properties.Resources.rectangle));
        ...
        public IMemorable StartDrawing(object sender, MouseEventArgs e)
        {
            ...
            return new RectMemoryItem(memoredRectangle, memoredBorderColor, memoredFillColor,
